...
def load_data(uploaded_file):
    """
    Load and parse text from uploaded .txt, .pdf, .docx, or image (.jpg, .jpeg, .png) file.
    ...
    try:
        ...
        if file_type == "txt":
            ...
            raise ValueError("Unsupported file type. Please upload a .txt, .pdf, .docx, .jpg, .jpeg, or .png file.")
